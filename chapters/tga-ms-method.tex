...
\paragraph{Abstract} The use of plastic materials in daily life\marginnote{This chapter was adapted from: \fullcite{DavidQuantitative2018}.\par See Page~\pageref{ch:author-contributions} for \nameref{ch:author-contributions}.}, industry, and agriculture can cause soil pollution with plastic debris down to the micrometer scale, namely, microplastics.
...
An alternative to this two-step approach is online \ac{tga-ms}, measuring simultaneously the masses of gases evolving during thermal treatment. Thermal treatment can either be oxidation (combustion) or pyrolysis in an inert \ch{Ar} atmosphere. A defined portion of gaseous degradation products are transferred into a quadrupole \ac{ms} via a heated capillary or a capillary\-/less orifice. The mass loss at a specific temperature is then related to the \ac{ms} signal of gaseous pyrolysis products.
...
For the subsequent measurement, the heating run was repeated from \SIrange[range-phrase = { to }]{-20}{310}{\degreeCelsius}. All runs were performed in hermetically sealed TZero pans\sidenote{TA Instruments, New Castle, USA.} under a \SI{50}{\milli\liter\per\minute} \ch{N2} flow and a thermal ramp of \SI{+-10}{\kelvin\per\minute}. All \ac{dsc} analyses were performed in triplicate.

\subsection{Preparation of Spiked Soil Samples}

Two calibration series were prepared, each in duplicate. For both experiments, a microscale\sidenote{Sartorius SE 02-OCE, Göttingen, Germany.} and \SI{85}{\micro\liter} alumina \ac{tga} crucibles\sidenote{NETZSCH, Selb, Germany.} were used. All specimens were weighed directly into the \ac{tga} crucible and carefully mixed.
...
\begin{marginfigure}
	...
	\caption[\Ac{tga} and \ac{dtg} curves and \SI{105}{\mz} ratios of blank soil, pure \ac{pet}, and an exemplary mixture of \ac{pet} debris in soil.]{\Acf{tga} and \acf{dtg} curves and normalized \SI{105}{\mz} ratios of blank soil, pure \ac{pet} (\SI{1.7274}{\milli\gram}), and an exemplary mixture of \SI{37.1}{\milli\gram\per\gram} \ac{pet} debris (\SI{1.7364}{\milli\gram}) in soil.}
